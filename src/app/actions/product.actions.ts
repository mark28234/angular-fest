...
export class LoadProductSuccess implements Action {
    ...
    constructor(public payload: Product[],public searchTerm?:string, public categories?:string[]) {
    }
}
...
// Section 4
export type Actions = LoadProduct | RemoveProduct | LoadProductSuccess | LoadProductDetail | LoadProductDetailSuccess;